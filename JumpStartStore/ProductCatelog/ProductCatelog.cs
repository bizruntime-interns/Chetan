...
namespace ProductCatelog
{
    /// <summary>
    /// An instance of this class is created for each service replica by the Service Fabric runtime.
    /// </summary>
    internal sealed class ProductCatelog : StatefulService, IStatefullInterface
    {
        public ProductCatelog(StatefulServiceContext context)
            : base(context)
        { }
        ...
        public async Task<Product> GetProducttById(int id)
        {
            var stateManager = this.StateManager;
        ...
        public async Task AddProductt(Product product)
        {
            var stateManager = this.StateManager;
