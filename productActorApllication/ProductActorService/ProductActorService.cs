...
namespace ProductActorService
{
    ...
    internal class ProductActorService : Actor, IProductActorService,IRemindable
    {
        ...
        {
            await this.StateManager.AddOrUpdateStateAsync(ProductStateName, product,updateValueFactory:(k,v)=>product, cancellationToken);
        ...
        public async Task ReceiveReminderAsync(string reminderName, byte[] state, TimeSpan dueTime, TimeSpan period)
        {
            ...
            {
                ActorEventSource.Current.ActorMessage(this, $"Remainder is doing work.");
            }
        }
    }
}
